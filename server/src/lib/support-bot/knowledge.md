...
员工 / 团队管理员 / 部门管理员 / 企业管理员可以在「个人中心」选择已有渠道、粘贴上游渠道 KEY 并提交，Key 进入平台资源池。超级管理员仍在「上游渠道」批量导入，个人中心没有该入口。提交入口不能新建渠道。
...
企业 / 部门 / 团队管理员不能替别人新建账号，只能邀请已经注册的手机号进团队。
超级管理员可以在「企业管理」批量注册用户（只要姓名和手机号），初始密码首次登录必须修改；批量注册的账号同样要等团队邀请才有员工权限。

## 还没进团队该找谁

用户还没进团队、问该找谁邀请时：先让对方说出企业名和团队名（或部门名），再查邀请人。
应找该团队的团队管理员，找不到再找部门管理员或企业管理员。
不要编造具体人名；用户没说团队名时，不要直接猜该找谁。
