...
--> statement-breakpoint
CREATE UNIQUE INDEX "projects_team_name_uidx" ON "projects" USING btree ("team_id","name");
--> statement-breakpoint
CREATE INDEX "projects_team_idx" ON "projects" USING btree ("team_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "project_members_project_employee_uidx" ON "project_members" USING btree ("project_id","employee_id");
--> statement-breakpoint
CREATE INDEX "project_members_employee_idx" ON "project_members" USING btree ("employee_id");
