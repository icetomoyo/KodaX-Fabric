...
async function goToRoleHome(role: ActAsPayload["role"] | "admin") {
  ...
  if (
    ...
    || path.startsWith("/admin/sensitive-words")
    || path.startsWith("/admin/sensitive-hits")
    || path.startsWith("/admin/sensitive-detect-records")
    || path.startsWith("/admin/sensitive-intercept-records")
