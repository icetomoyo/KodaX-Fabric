  ...
  <el-container class="shell">
    <el-aside width="220px" class="aside">
      ...
      <el-menu :default-active="route.path" router>
        ...
        <el-menu-item index="/admin/providers">供应商 / 产品线</el-menu-item>
        <el-menu-item v-if="auth.isAdmin" index="/admin/credentials">上游凭证池</el-menu-item>
        <el-menu-item v-if="auth.isAdmin" index="/admin/model-routes">模型路由</el-menu-item>
