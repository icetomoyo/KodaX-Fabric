...
| 产品基线 | v0.0.4 |
| 文档版本 | 1.3 |
| 产品状态 | v0.0.4 功能实现与本地验证完成，待部署发布 |
| 编制日期 | 2026-08-06 |
| 适用对象 | 产品、研发、测试、运维、信息安全与合规相关人员 |

本文正文定义截至 v0.0.4 的目标产品规则。各项能力的实际可用性以第 5 节状态标记和第 13 节交付状态为准。

> **修订说明（v0.0.4）**：产品权限收敛为员工与管理员双角色；管理首页渠道统计按 `product_lines` 聚合。v0.0.3 起配额策略仍为**按员工的单日总 Token 硬上限**，RPM/并发为系统级固定 safeguard。
