...
放行说明：R1、R8、R9、R16 已通过；E2 演练、E5 配额（5 亿/人/日）、E7 对接人（张闯 / 18612243416）已由负责人确认写入章程与 runbook。已知体验问题：日配额触顶时客户端易显示 Retry 而非明确「额度用尽」——见 [KNOWN_ISSUES 001](KNOWN_ISSUES.pilot.md)，后续优化。
