...
| 版本 | 状态 | 进度 | 说明 |
|------|------|------|------|
| v0.0.1 | Planned | 0/1 | 最小双端点网关（本表只登这一版） |
...
切法全文：[token-hub-slices.md](token-hub-slices.md)。手测：[TokenHub_VISION.md](TokenHub_VISION.md)。

## Feature Index

| ID | Title | Status | Priority | Category | Planned | Design |
|----|-------|--------|----------|----------|---------|--------|
| 001 | 最小双端点网关 | Planned | Critical | New | v0.0.1 | [设计](features/v0.0.1.md#feature_001) |
