import{u as x,j as e,N as y,c as r,L as h,O as m}from"./index-DFInAboH.js";import{u as p}from"./hooks-sNi9Di8I.js";import{c as s}from"./createLucideIcon-CEho88zt.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=[["circle",{cx:"12",cy:"4.5",r:"2.5",key:"r5ysbb"}],["path",{d:"m10.2 6.3-3.9 3.9",key:"1nzqf6"}],["circle",{cx:"4.5",cy:"12",r:"2.5",key:"jydg6v"}],["path",{d:"M7 12h10",key:"b7w52i"}],["circle",{cx:"19.5",cy:"12",r:"2.5",key:"1piiel"}],["path",{d:"m13.8 17.7 3.9-3.9",key:"1wyg1y"}],["circle",{cx:"12",cy:"19.5",r:"2.5",key:"13o1pw"}]],M=s("Waypoints",L),z=[{to:"/admin/overview",label:"总览",icon:k},{to:"/admin/users",label:"用户",icon:_},{to:"/admin/providers",label:"上游钥匙",icon:N},{to:"/admin/pools",label:"渠道池",icon:b},{to:"/admin/channels",label:"渠",icon:M},{to:"/admin/keys",label:"虚拟钥匙",icon:g}];function H(){var n,o;const{operator:t,logout:i}=x(),c=p();return e.jsxs("div",{className:"flex min-h-screen",children:[e.jsxs("aside",{className:"sticky top-0 flex h-screen w-56 shrink-0 flex-col border-r border-border bg-card/60 px-3 py-6",children:[e.jsxs("div",{className:"px-3",children:[e.jsx("p",{className:"font-mono text-[10px] uppercase tracking-[0.28em] text-ember-400/80",children:"KodaX-Fabric"}),e.jsx("div",{className:"font-serif text-lg",children:"编目"})]}),e.jsx("nav",{className:"mt-8 space-y-1",children:z.map(a=>{const l=a.icon;return e.jsxs(y,{to:a.to,className:({isActive:d})=>r("flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm transition-colors",d?"bg-accent text-foreground":"text-muted-foreground hover:text-foreground"),children:[e.jsx(l,{size:14}),a.label]},a.to)})}),e.jsxs("div",{className:"mt-auto space-y-2 px-3 text-sm",children:[e.jsx(h,{to:"/app",className:"block text-muted-foreground transition-colors hover:text-foreground",children:"我的工作台"}),e.jsx("button",{onClick:()=>void i(),className:"text-muted-foreground transition-colors hover:text-foreground",children:"退出"})]})]}),e.jsxs("main",{className:"min-w-0 flex-1 px-8 py-8",children:[e.jsx("div",{className:"mb-6 flex items-center justify-end",children:e.jsxs("span",{className:"flex items-center gap-2 font-mono text-xs text-muted-foreground",children:[e.jsx("span",{className:r("h-1.5 w-1.5 rounded-full",(n=c.data)!=null&&n.ok?"bg-emerald-400":"bg-white/20")}),(o=c.data)!=null&&o.ok?"healthy":"health unknown"]})}),e.jsx("p",{className:"sr-only",children:(t==null?void 0:t.name)||(t==null?void 0:t.phone)}),e.jsx(m,{})]})]})}export{H as default};
