...
ALTER TABLE requests ADD COLUMN IF NOT EXISTS customer_cny DOUBLE PRECISION NOT NULL DEFAULT 0;
ALTER TABLE requests ADD COLUMN IF NOT EXISTS request_id TEXT NOT NULL DEFAULT '';
