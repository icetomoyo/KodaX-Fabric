...
企业级 Token 统一接入与效能管理。发布 **v0.0.5**。当前落地模块是 **Token Hub**（HLD：Go 单进程网关）。
...
| [docs/FEATURE_LIST.md](docs/FEATURE_LIST.md) | Feature 索引（当前 v0.0.5） |
| [docs/features/v0.0.5.md](docs/features/v0.0.5.md) | 本版规格与票 |
